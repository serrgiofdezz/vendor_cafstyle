# Copyright (C) 2017 Unlegacy-Caf
# Copyright (C) 2017 The CodeAurora Forum Project
# Copyright (C) 2018 The BrainRepo Project
#
...
bacon: $(INTERNAL_OTA_PACKAGE_TARGET)
	...
	$(hide) ./vendor/cafstyle/tools/generate_json_build_info.sh $(CUSTOM_TARGET_PACKAGE)
